...
class Brick extends Sprite {
    ...
    addClass(class1 : string){
        this.sprite.classList.add(class1);
    }
}
...
class HardBrick extends Brick {
    ...
    constructor(brick: HTMLElement){
        super(brick);
        brick.classList.add('hard');
    }

    reset() {
        this.show();
        this.lives = 2;
        this.sprite.classList.remove("hitted");
        this.sprite.classList.add("hard");
    }
}
